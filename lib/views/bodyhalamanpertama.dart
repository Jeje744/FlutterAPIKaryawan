...
class _BodyHalamanPertamaState extends State<BodyHalamanPertama> {
  ...
  void booleand() async {
    if (await SessionManager().get('datas') == null) {
      print('Sesi Belum di buat');
    } else {
      print('Sesi Sudah diBuat');
      setState(() {
        _show_button = !_show_button;
        _show_content = !_show_content;
      });
    }
  }

  Future<void> setSession() async {
    await SessionManager().set('datas', 'Data Sesi');
    setState(() {
      _show_button = !_show_button;
      _show_content = !_show_content;
    });
  ...
  void showSesi() async {
    var sesi = await SessionManager().get('datas');
    print(sesi);
  }
